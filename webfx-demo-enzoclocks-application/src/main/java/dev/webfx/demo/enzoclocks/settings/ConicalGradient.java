...
public class ConicalGradient {
    ...
    public Image getRoundImage(final double SIZE) {
        ...
        double cx = centerX == 0 ? radius : centerX;
        double cy = centerY == 0 ? radius : centerY;
        int    calculatedStopsLength = sortedStops.size() - 1;
...
*/
    ...
    private double adjustAngle(final double DX, final double DY, double angle) {
        if (Double.compare(DX, 0) >= 0 && Double.compare(DY, 0) <= 0) {
            ...
            angle = 450.0 - angle;  // Upper Left Quadrant
        }
    ...
    */
    ...
    public ConicalGradient createSteelGradient() {
        return new ConicalGradient(
                new Stop(0.00, Color.gray(0.99)),
                new Stop(0.03, Color.gray(0.99)),
                new Stop(0.10, Color.gray(0.70)),
                new Stop(0.14, Color.gray(0.67)),
                new Stop(0.24, Color.gray(0.99)),
                new Stop(0.33, Color.gray(0.43)),
                new Stop(0.38, Color.gray(0.43)),
                new Stop(0.50, Color.gray(0.99)),
                new Stop(0.62, Color.gray(0.67)),
                new Stop(0.67, Color.gray(0.70)),
                new Stop(0.76, Color.gray(0.99)),
                new Stop(0.81, Color.gray(0.43)),
                new Stop(0.85, Color.gray(0.43)),
                new Stop(0.97, Color.gray(0.99)),
                new Stop(1.00, Color.gray(0.99))
        );
    }
